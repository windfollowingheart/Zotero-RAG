...
export class UIExampleFactory {
  ...
  static registerZoteroRagButtonContainer(win: Window) {
      ...
      .addCell(0, 0, {
        ...
        properties: { 
          innerHTML: `<div style="width: 100%; height: 100%; 
            ...
            ">
            <div class="zotero-rag-insert-task-list-container-show-button-div" 
            style="background-color:rgb(190, 211, 214); border-radius: 5px; padding: 5px;">
              文档解析
            </div>
            <div class="zotero-rag-chat-container-show-button-div" 
            style="background-color:rgb(190, 211, 214); border-radius: 5px; padding: 5px;">
             聊天界面
            </div>
          </div>`
